...
// MODEL: homeAway RESTORED at 0.05 (back from counterMatchup), now backed by
// calcVenueStrengthModifier's plain symmetric-diff model (engine/fixtures.js)
// rather than the earlier league-normalised, weighted calcVenueEffect. FPL's
// own base FDR already factors venue into its rating to some degree, so this
// metric still overlaps baseDifficulty rather than reading something wholly
// independent — kept deliberately small (0.05) for that reason.
export const WEIGHTS = {
  ...
  homeAway:       0.05,   // venue performance this season — see MODEL note above
